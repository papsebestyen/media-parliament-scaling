...
parl_tokens <- read_rds("data/intermed/migrant_tokens.rds")
selected_ps <- read_rds("data/intermed/migrant_selected_phrases.rds")
tmod_ws <- read_rds("data/intermed/migrant_wordscore_fit.rds")
...
predicted_slant %>% write_csv("data/slant_estimates/migrant_party_slant_pred.csv")
